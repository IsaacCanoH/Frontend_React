const LoginHeader = () => (
  <>
    ...
    <div className="col-lg-5 d-none d-lg-block position-relative bg-primary vh-100 overflow-hidden">
      ...
      <div className="position-absolute top-50 start-50 translate-middle text-center text-white z-index-1 px-4">
        ...
        <p className="lead mb-4">
          Instituto Nacional para la Educación de los Adultos en el Estado de Guanajuato
        </p>
    ...
    <div className="col-12 d-lg-none bg-primary text-white text-center py-2">
      <h2 className="fw-bold mb-1 fs-4">INAEBA</h2>
